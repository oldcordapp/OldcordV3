...
const Paginator = ({ header, tabs, children, maxPerPage = 5 }) => {
    ...
    const paginatedChildren = children.length > maxPerPage ? (children.slice(startIndex, startIndex + maxPerPage)) : children;
                            ...
                            <tr>
                                {tabs.map((tab) => (
                                    <th className='mainPage-main-components-infoCard-table-th' key={tab}>
                                        <div className='mainPage-main-components-infoCard-table-th-header' style={{'textAlign' : 'left'}}>{tab}</div>
                                    </th>
                                ))}
                            </tr>
                        </thead>
                        ...
                        <div className='mainPage-main-components-navigation'>
                            <div className='mainPage-main-components-paginator'>
                                <div className='mainPage-main-components-paginator-inner'>
                                    <div className='mainPage-main-components-paginator-arrow' id="left" onClick={handlePrevPage}>
                                        <Ic_pageLeft style={{fill: "currentColor"}}/>
                                    </div>
                                    <div className='mainPage-main-components-paginator-separator'></div>
                                    <div className='mainPage-main-components-paginator-arrow' id="right" onClick={handleNextPage}>
