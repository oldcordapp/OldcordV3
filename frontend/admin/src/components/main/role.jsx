  ...
  return (
    <>
      ...
      >
        ...
        <td className="mainPage-main-components-infoCard-table-td">{permissions}</td>
        <td className="mainPage-main-components-infoCard-table-td">{position}</td>
        <td className="mainPage-main-components-infoCard-table-td">{color}</td>
        <td className="mainPage-main-components-infoCard-table-td">{hoist ? 'Yes' : 'No'}</td>
        <td className="mainPage-main-components-infoCard-table-td">{mentionable ? 'Yes' : 'No'}</td>
      </tr>
    </>
  );
};
