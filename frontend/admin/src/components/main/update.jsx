...
const Update = ({ status, error, latestCommit, repoUrl }) => {
    switch (status) {
        ...
        case 'up-to-date':
            return <div className="search-no-results"><img src={ic_satisfied} alt="Congrats! You are running the latest version." /><p>Congrats! You are running the latest version.</p></div>;
                ...
                <div className="update-available">
                    ...
                    <div className='update-instructions'>
                        ...
                        <ol>
                            ...
                            <li>Run <div className='block'>git pull</div>.</li>
                            <li>Update <div className='block'>config.json</div> if needed.</li>
                            <li>Run <div className='block'>npm run start</div>.</li>
                        </ol>
                    </div>
                </div>
            );
        case 'update-disabled':
            return <div className="search-no-results"><img src={ic_error} alt="Update is disabled due to VITE_APP_DISABLE_UPDATE_CHECK is true." /><p>Update is disabled due to VITE_APP_DISABLE_UPDATE_CHECK is true.</p></div>;
        case 'error':
            return <div className="search-no-results"><img src={ic_error} alt="Error checking for updates." /><p>Error checking for updates: {error}</p></div>;
    }
}
