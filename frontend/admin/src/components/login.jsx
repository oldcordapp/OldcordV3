        ...
        <form onSubmit={handleSubmit}>
          <div className="loginPage-card">
            <div className="loginPage-card-contents">
              <div
                className="loginPage-account avatar"
                style={{ backgroundImage: `url('${DefaultAvatar}')` }}
              ></div>
              <div className="loginPage-card-text">
                Login to the admin panel with your Oldcord instance staff account.
              </div>
            </div>
            <button
