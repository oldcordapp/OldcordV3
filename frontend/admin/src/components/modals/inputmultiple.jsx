...
function InputMultiple({ summary, fields, onCancel, cancelName, onComplete, completeName, showFieldSpan = true, fieldSeparatorGap = 25, minWidthForm = 300, minWidthInput = 300}) {
    ...
    return (
        <div className="modal-overlay" onClick={onCancel}>
            <div className="confirmation-modal-wrapper" onClick={(e) => e.stopPropagation()} style={{minWidth: minWidthForm}}>
                <div className="confirmation-modal">
                    <div className="confirmation-modal-inner">
                        ...
                        <div className="confirmation-modal-inner-buttons-wrapper">
                            ...
                            <button className={`largeButton yes-button ${isYesButtonDisabled ? 'disabled-btn' : ''}`} disabled={isYesButtonDisabled} onClick={handleComplete}>
